...
// The svg file uses a coordinate system where after transform, Y decreases (scale y negative),
// but we already applied the raw scale and translate. Print results.

const padding = 6; // add a small padding
...
// Additionally, since the original SVG had viewBox in the 0..1024 coordinate system, but
// the transformed coords are now in that same space after applying translate+scale, the
// suggested viewBox can be used as-is.
